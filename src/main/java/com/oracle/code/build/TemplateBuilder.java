...
import com.oracle.code.swagger.*;
import com.oracle.code.util.JavaTypes;
import com.oracle.code.util.ModelInfo;
import com.oracle.code.util.StringUtils;
...
public class TemplateBuilder {
    ...
    static {
        try {
            ...
            PROJECT_PATH= TemplateBuilder.class.getClassLoader().getResource("").getPath();
